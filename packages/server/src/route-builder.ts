...
import type { BaseOptions } from "./utils/options";
...
> {
  ...
  public derive<Derived extends Record<string, any>>(fn: (options: Prettify<TOptions>) => Derived) {
    return new RouteBuilder<TOptions & Derived, TInputs, TErrorResponse>({
      ...this.opts,
  ...
  public body<Schema extends AnySchema>(schema: Schema) {
    ...
    return new RouteBuilder<
      Prettify<Omit<TOptions, "body"> & { body: AnyOutput<Schema> }>,
  ...
  public query<Schema extends AnySchema>(schema: Schema) {
    ...
    return new RouteBuilder<
      Prettify<Omit<TOptions, "query"> & { query: AnyOutput<Schema> }>,
  ...
  public before<const Return extends MaybePromise<PossibleResponse | void>>(
    fn: (options: Prettify<TOptions>) => Return,
  ) {
    return new RouteBuilder<TOptions, TInputs, TErrorResponse>({
      ...this.opts,
  ...
  public after<const Return extends MaybePromise<PossibleResponse | void>>(
    fn: (response: PossibleResponse, options: Prettify<TOptions>) => Return,
  ) {
    return new RouteBuilder<TOptions, TInputs, TErrorResponse>({
      ...this.opts,
  ...
  public error<const Return extends MaybePromise<PossibleResponse>>(
    fn: (error: unknown, options: Prettify<TOptions>) => Return,
  ) {
    return new RouteBuilder<TOptions, TInputs, InferResponse<Awaited<Return>>>({
      ...this.opts,
      errorHandler: fn,
    });
  }
  ...
  public get<const TPath extends string, const TReturn extends MaybePromise<PossibleResponse>>(
    path: TPath,
    fn: (options: Prettify<TOptions & { params: GetPathParameters<TPath> }>) => TReturn,
  ) {
  ...
  >(method: TMethod, path: TPath, fn: (options: Prettify<TOptions & { params: GetPathParameters<TPath> }>) => TReturn) {
